...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameManager.instance.OnItemsMenu += ActivateItensMenu;
    ...
    private void ActivateMainMenu(){
        ...
        itemsMenuCanvas.transform.GetChild(0).transform.DOScale(new Vector3(8, 0, 8), 0.5f);
        itemsMenuCanvas.transform.GetChild(1).transform.DOScale(new Vector3(0, 9, 0), 0.3f);
    ...
    private void ActivateItensMenu(){
        ...
        itemsMenuCanvas.transform.GetChild(1).transform.DOMoveY(500, 0.3f);
    }
